...
[[file:img/2019-12-17_14-28-10_screenshot.png]]

* Eksempel
#+attr_html: :width 600px
[[file:img/2019-12-15_12-42-22_https%253A%252F%252Fblogs-images.forbes.com%252Fsamabuelsamid%252Ffiles%252F2017%252F07%252Fapi-rating-image.jpg]]
...
#+attr_html: :width 600px
[[file:img/2019-12-15_13-37-53_screenshot.png]]
#+reveal_html: </div>
...
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_15-03-28_screenshot.png]]

#+attr_html: :width 300px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_15-03-48_screenshot.png]]
...
#+DOWNLOADED: screenshot @ 2019-12-17 15:04:33
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_15-04-33_screenshot.png]]
...
#+attr_latex: :width 10cm
[[file:img/2019-12-17_08-10-53_screenshot.png]]
...
#+attr_reveal: :frag (appear)
#+begin_quote
I et isoleret system er den samlede impuls bevaret.
Altså $\vec{p}$ er konstant.
#+end_quote
...
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2020-01-28_08-38-51_screenshot.png]]
...
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_15-15-43_screenshot.png]]
#+reveal_html: </div>

** Eksempel
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_10-15-37_screenshot.png]]
...
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_15-07-15_screenshot.png]]

* Stødprocesser
  
** Stød uden ydre kræfter

#+DOWNLOADED: screenshot @ 2019-12-17 10:30:59
#+attr_html: :width 350px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_10-30-59_screenshot.png]]
...
#+attr_html: :width 350px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_10-35-37_screenshot.png]]
#+reveal_html: </div>

** Elastiske stød
#+BEGIN_EXPORT html
<video controls width="500">
<source src="https://ku.23video.com/7718126/8160403/04df6f88f32076e403ae7e0f4d424a0e/video_hd/elastisk-stod-1-video.mp4?uuid=1efff373-451a-088a-a088-98fd825de4c6" type="video/mp4">
</video>
#+END_EXPORT
...
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_11-21-02_screenshot.png]]
#+reveal_html: </div>
...
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_12-02-08_screenshot.png]]
#+attr_reveal: :frag (appear)
...
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2020-01-28_08-47-30_screenshot.png]]
...
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_15-21-04_screenshot.png]]
#+reveal_html: </div>

#+reveal: split
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_15-35-43_screenshot.png]]
...
#+DOWNLOADED: screenshot @ 2019-12-17 12:22:44
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_12-22-44_screenshot.png]]
#+reveal_html: </div>
...
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_12-31-50_screenshot.png]]

#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_12-32-31_screenshot.png]]
...
#+attr_reveal: :frag (appear)
#+begin_quote
Massemidtpunktets impuls er lig hele systemets impuls.
#+end_quote
...
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_13-05-29_screenshot.png]]
#+attr_reveal: :frag (appear)
...
#+attr_html: :width 600px 
#+attr_latex: :width 10cm
[[file:img/2019-12-17_13-19-47_screenshot.png]]

#+reveal: split
Kast med stav med tre lysdioder.
#+attr_html: :width 400px 
#+attr_latex: :width 10cm
[[file:img/2019-12-17_13-20-13_screenshot.png]]

** Regnetid

#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_17-08-58_screenshot.png]]
...
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_13-27-18_screenshot.png]]
#+reveal_html: </div>

** Regnetid
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_14-21-35_screenshot.png]]
...
#+reveal_html: <div style="font-size: 60%;">
#+reveal_html: <div class="column" style="float:left; width: 70%">
- For lodret opsendelse tæt på Jorden gælder
  $$F_{\mathrm{res}}=m \cdot a_{\mathrm{res}}=F_{\mathrm{raket}}-F_{\mathrm{t}} = -u \cdot \frac{dm}{dt} - m \cdot g$$
- Den resulterende acceleration bliver
  $$a_{\mathrm{res}} = \frac{dv}{dt}= -u \cdot \frac{1}{m}\cdot \frac{dm}{dt}-g$$
- Som integreres til
  $$\boxed{v(t) -v_0 = -u \cdot \ln \left( \frac{m(t)}{m_0} \right)-g\cdot t}$$
#+attr_reveal: :frag (appear)
#+reveal_html: </div>
...
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_15-39-02_screenshot.png]]
#+reveal_html: </div>

#+reveal_html: <div class="column" style="float:right; width: 50%">
#+attr_html: :width 600px
#+attr_latex: :width 10cm
[[file:img/2019-12-17_15-39-20_screenshot.png]]
#+reveal_html: </div>
